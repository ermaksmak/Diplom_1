...
class TestDatabase:
    def test_available_buns(self):      # тест на проверку списка доступных булок
        database = Database()
    ...
    def test_available_ingredients(self):      # тест на проверку списка доступных ингредиентов
        database = Database()
